                            ...
                            <div className="p-4 bg-zinc-900">
                                <div className="bg-zinc-800/50 rounded-lg p-4 mb-4">
                                    <p className="text-zinc-300 text-sm leading-relaxed">
                                        👋 Halo! Welcome to <span className="font-semibold text-white">Noud AI</span>
                                    </p>
                                    <p className="text-zinc-400 text-xs mt-2">
                                        I’m Noudy. Let me show you how custom AI can simplify your workflows and boost your revenue today
                                    </p>
                                </div>
